...
This application was developed by [Alfredo Suarez](https://github.com/sibokdev) when reading and following the book:
[Cloud Native Spring in Action](https://www.manning.com/books/cloud-native-spring-in-action).
It's a book catalog service to manage all crud operations.
